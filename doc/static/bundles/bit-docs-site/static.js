...
System.bundles = {"bundles/bit-docs-site/static.css!":["bit-docs-html-canjs@0.4.8#static/canjs.less!$less","bit-docs-prettify@0.1.1#prettify.less!$less","bit-docs-site@0.0.1#styles/styles.less!$less"]};
/*npm-utils*/
...
define('package.json!npm', [
    ...
    (function (loader, packages, options) {
        ...
        },
        {
            ...
            'globalBrowser': {},
            'browser': {},
            'resolutions': { 'bit-docs-html-canjs': '0.4.8' }
        },
        {
...
/*bit-docs-html-canjs@0.4.8#static/canjs*/
define('bit-docs-html-canjs@0.4.8#static/canjs', function (require, exports, module) {
    require('./canjs.less!');
    $ = require('jquery');
    var $articleContainer, $onThisPage, $tableOfContents, $onThisPageTitle, $everything, $headers, $nav, headerHidden, animating, navigating, scrollPositionInterval, currentHref;
    (function () {
        init();
...
/*bit-docs-prettify@0.1.1#prettify-engine*/
define('bit-docs-prettify@0.1.1#prettify-engine', [
    'module',
    '@loader'
...
/*bit-docs-prettify@0.1.1#prettify*/
define('bit-docs-prettify@0.1.1#prettify', function (require, exports, module) {
